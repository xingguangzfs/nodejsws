...
router.post('/', function(req, res, next) {
    ...
    util.printLog('user statis query req body', req_body);
    ...
    var db_name = statis_base.getStatisDbName('statis_user', cycle_id);

    var strMaxSql = "SELECT COUNT(*) AS max_count FROM " + db_name;

    var strSql = "SELECT id,user_name,cycle_id,";
    ...
    strSql += "login_count,app_count,app_inst_count,";
    strSql += "remark FROM ";
    strSql += db_name;
