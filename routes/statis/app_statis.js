/**
 * Created by fushou on 2019/12/16.
 */
/**
...
router.post('/', function(req, res, next) {
    ...
    util.printLog('app statis query req body', req_body);
    ...
    var db_name = statis_base.getStatisDbName('statis_app', cycle_id);

    var strMaxSql = "SELECT COUNT(*) AS max_count FROM " + db_name;

    var strSql = "SELECT id,file_name,app_full_name,app_desc,app_size,cycle_id,";
    ...
    strSql += "host_count,user_count,app_inst_count,";
    strSql += "remark FROM ";
    strSql += db_name;
