...
router.post('/', function(req, res, next) {
    ...
    if (global.print_log) {
        console.log('app modify group req body: ' + JSON.stringify(req_body));
    }

    var ids = req_body.ids;
    var names = req_body.names;
    ...
    // UPDATE res_app SET group_id=2 WHERE app_name IN (SELECT DISTINCT app_name FROM res_app WHERE id IN (2,3))

    var strSql = "";

    // 修改
    strSql = "UPDATE res_app SET ";
