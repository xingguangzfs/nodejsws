...
router.post('/', function(req, res, next) {
    ...
    if (global.print_log) {
        console.log('host group delete req body: ' + JSON.stringify(req_body));
    }
    ...
    if (group_id < 1) {
        ...
        var strSql = "DELETE FROM res_as_group WHERE id=" + group_id;

        var strHostSql = "UPDATE res_as SET group_id=0 WHERE group_id=" + group_id;
        ...
        modify_db.delete(strSql, function(err, result) {
            ...
            if (err) {
                ...
                modify_db.modify(strHostSql, null, function(err2, result2){
                    if (global.print_log) {
