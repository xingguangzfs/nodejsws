/**
 * Created by fushou on 2019/12/2.
 */
...
router.post('/', function(req, res, next){
    ...
    util.printLog('log cloud query req body', req_body);
    ...
    var strMaxCountSql = "SELECT COUNT(*) AS max_count FROM log_cloud t1, log_level t2 ";
    ...
    strSql += "t1.user_name,t1.info,t1.remark FROM log_cloud t1, log_level t2 ";
