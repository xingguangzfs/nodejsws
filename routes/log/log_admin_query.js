...
router.post('/', function(req, res, next) {
    ...
    util.printLog('log admin query req body', req_body);
    ...
    // SELECT t1.id,t1.level_id,t2.name AS level_name,t1.source,t1.event_tm,t1.user_name,t1.info,t1.remark FROM log_admin t1, log_level t2 WHERE t1.level_id=t2.id

    var strMaxCountSql = "SELECT COUNT(*) AS max_count FROM log_admin t1, log_level t2 ";
    ...
    strSql += "t1.user_name,t1.info,t1.remark FROM log_admin t1, log_level t2 ";
