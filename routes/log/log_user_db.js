...
exports.insertData = function(param, callback) {
    var resData = {};
    var strSql = log_sql.getLogUserInsertSql(param);
    ...
    modify_db.insert(strSql, null, function(err, result){
        util.printLog('log_user_db strSql', strSql);
        util.printLog('log_user_db result', result);
        if (err) {
...
exports.modifyData = function(param, where_param, callback) {
    var resData = {};
    var strSql = log_sql.getLogUserModifySql(param, where_param);
...
exports.deleteData = function(where_param, callback) {
    var resData = {};
    var strSql = log_sql.getLogUserDeleteSql(where_param);
...
exports.queryData = function(fields, where_param, where_op, callback) {
    var resData = {};
    var strSql = log_sql.getLogUserQuerySql(fields, where_param, where_op);
...
exports.query2Data = function(fields, where_sql, callback) {
    var resData = {};
    var strSql = log_sql.getLogUserQuerySql2(fields, where_sql);
