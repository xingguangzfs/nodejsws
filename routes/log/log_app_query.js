...
router.post('/', function(req, res, next) {
    ...
    util.printLog('log app query req body', req_body);
    ...
    var strMaxCountSql = "SELECT COUNT(*) AS max_count FROM log_app t1, log_level t2 ";
    ...
    strSql += "t1.user_name,t1.info,t1.app_desc,t1.app_path,t1.app_size,";
    strSql += "t1.app_process_id,t1.remark FROM log_app t1, log_level t2 ";
