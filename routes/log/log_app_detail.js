...
router.post('/', function(req, res, next){
    ...
    util.printLog('log app detail req body', req_body);
    ...
    strSql += "user_name,info,detail,app_desc,app_path,app_size,";
    strSql += "app_process_id,remark ";
    strSql += " FROM log_app WHERE id=" + item_id;
